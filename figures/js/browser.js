...
var COLORS = {
    ...
    "meta": { "C": "#01665e", "M": "#35978f", "S": "#80cdc1", "R": "#A0B3B0" },
    "sig": { "C": "#8c510a", "M": "#B68A44", "S": "#dfc27d", "R": "#B7B09F" },
    "perc": d3.scaleLinear()
        .range(["#0571b0", "#92c5de", "#aaa", "#f4a582", "#ca0020"])
        .domain([0, 50, 100, 150, 200]),
    "param": d3.scaleLinear()
        .range(["#0571b0", "#92c5de", "#aaa", "#f4a582", "#ca0020"])
        .domain([50, 75, 100, 125, 150]),
}
